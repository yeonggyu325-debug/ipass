...
console.log(JSON.stringify({success:true,consolidated_worker:true,html_injection_guard:true,unified_partner_admin:true,ui_asset_injection:'worker-only',submission_css:'single-file',legacy_files_removed:removed.length}));