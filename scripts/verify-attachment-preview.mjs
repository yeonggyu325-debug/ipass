...
if (!worker.includes('/resource-preview-v2.js?v=7')) failures.push('resource-preview:v2-cache-bust');
if (!worker.includes('/resource-preview-v3.js?v=7')) failures.push('resource-preview:v3-cache-bust');
