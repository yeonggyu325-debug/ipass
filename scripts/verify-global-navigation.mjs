...
assert.ok(foundation.includes('EHS UI Foundation v3')&&foundation.includes('--ehs-container-max: 1320px')&&foundation.includes('--ehs-page-gutter: 24px')&&foundation.includes('--ehs-section-gap: 24px'),'공통 레이아웃 토큰은 foundation v3에서 관리해야 함');
...
console.log(JSON.stringify({success:true,services:services.length,unified_partner_admin:true,admin_ui_balanced:true,account_delete:true,signup_position_as_job_title:true,partner_logo_clipboard:true,signup_whitelist:true,consolidated_worker:true,toolbar_identity_unified:true,toolbar_interactions_preserved:true,ui_foundation:'v3'}));