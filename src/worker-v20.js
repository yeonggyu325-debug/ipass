...
const SUBMISSION_ASSETS='<link rel="stylesheet" href="/evaluation-submit-enhance.css?v=3"><link rel="stylesheet" href="/evaluation-submit-redesign.css?v=3"><link rel="stylesheet" href="/evaluation-submit-progress.css?v=4"><script src="/evaluation-submit-enhance.js?v=12"></script>';
...
async function injectShared(response,{home=false,root=false,submission=false,embedded=false}={}){
  ...
  if(submission)html=injectBody(html,SUBMISSION_ASSETS,'evaluation-submit-enhance.js?v=12');if(embedded)html=injectHead(html,EMBED_STYLE,'ipass-embedded-style');return htmlResponse(response,html)
}
