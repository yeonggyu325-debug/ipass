...
export function normalizeInjectedBodyScripts(html) {
  ...
  return output
    ...
    .replaceAll('/ehs-ui-foundation.css?v=2','/ehs-ui-foundation.css?v=4')
    .replaceAll('/ehs-ui-foundation.css?v=3','/ehs-ui-foundation.css?v=4')
    .replaceAll('/portal-shell-v1.css?v=2','/portal-shell-v1.css?v=3')
    .replaceAll('/global-toolbar-v5.css?v=5','/global-toolbar-v5.css?v=7')
    .replaceAll('/global-toolbar-v5.css?v=6','/global-toolbar-v5.css?v=7')
    .replaceAll('/portal-home-v3.css?v=4','/portal-home-v3.css?v=5')
