...
const RESOURCE_PREVIEW_V3_STYLE='<link rel="stylesheet" href="/resource-preview-v2.css?v=7"><link rel="stylesheet" href="/resource-preview-v3.css?v=7">';
const RESOURCE_PREVIEW_V3_SCRIPT='<script src="/resource-preview-v2.js?v=7"></script><script src="/resource-preview-v3.js?v=7"></script>'; 
...
async function injectShared(response,{path='/',home=false,root=false,submission=false,embedded=false}={}){
  ...
  if(path==='/resources'){html=injectHead(html,RESOURCE_PREVIEW_V3_STYLE,'/resource-preview-v3.css?v=7');html=injectBody(html,RESOURCE_PREVIEW_V3_SCRIPT,'/resource-preview-v3.js?v=7')}
