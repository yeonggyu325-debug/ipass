(function(){
  ...
  function markup(){
    ...
    return `<header class="ehs-global-header ehs-toolbar-v4" id="ehsGlobalHeader"><div class="ehs-global-inner">
      <div class="ehs-v4-brand-zone"><a class="ehs-global-brand" href="/home" aria-label="협력사 EHS 포털 홈"><img src="/hniruja-logo.png" alt="Hniruja"><span class="ehs-v4-brand-copy"><strong>협력사 EHS 포털</strong><small>Hniruja Safety Workspace</small></span></a></div>
  ...
  function install(){
    ...
    const old=document.getElementById('ehsGlobalHeader');if(old)old.remove();
    document.body.insertAdjacentHTML('afterbegin',markup());
    document.body.classList.add('ehs-global-nav-ready','ehs-toolbar-v4-ready');
    bind();
