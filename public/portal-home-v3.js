(function(){
  ...
  function buildPortalHome(){
    const page=document.getElementById('page-portalHome');if(!page||page.dataset.homeV3==='1')return;page.dataset.homeV3='1';
    page.innerHTML=`<div class="home-v3-shell">
      ...
      <section class="home-v3-section" aria-labelledby="homeServiceTitle"><div class="home-v3-section-head"><div><h2 id="homeServiceTitle">업무메뉴</h2><p>자주 사용하는 EHS 업무를 빠르게 실행합니다.</p></div></div><div class="service-panel">
        <button class="service-tile" type="button" onclick="openPortalService('notices')"><span class="service-icon"><svg viewBox="0 0 24 24"><path d="M6 4h12v16H6z"/><path d="M9 8h6M9 12h6M9 16h4"/></svg></span><span class="service-text"><strong>공지사항</strong><span>주요 안내 및 공지</span></span></button>
        ...
        <button class="service-tile" type="button" onclick="openPortalService('resources')"><span class="service-icon"><svg viewBox="0 0 24 24"><path d="M4 6h6l2 2h8v10H4z"/><path d="M8 12h8"/></svg></span><span class="service-text"><strong>자료실</strong><span>공통 양식 및 안전자료</span></span></button>
        <button class="service-tile" type="button" onclick="openPortalService('ipass')"><span class="service-icon"><svg viewBox="0 0 24 24"><path d="M7 3h10v4H7z"/><path d="M5 5v16h14V5"/><path d="M8 11h8M8 15h5"/></svg></span><span class="service-text"><strong>i-PaSS</strong><span>안전보건 이행수준평가</span></span></button>
        ...
        <button class="service-tile" type="button" onclick="openPortalService('faq')"><span class="service-icon"><svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="9"/><path d="M9.8 9a2.4 2.4 0 1 1 3.7 2c-1 .7-1.5 1.1-1.5 2.2M12 17h.01"/></svg></span><span class="service-text"><strong>FAQ</strong><span>자주 묻는 질문</span></span></button>
      </div></section>
      <section class="home-v3-section home-v3-notices" aria-labelledby="homeNoticeTitle"><div class="home-v3-section-head"><div><h2 id="homeNoticeTitle">공지</h2><p>업무에 필요한 최신 안내를 확인합니다.</p></div><button class="home-v3-text-link" type="button" onclick="openPortalService('notices')">전체보기 ›</button></div><div class="home-panel home-v3-notice-panel"><div class="notice-home-list" id="homeNoticeList"><div class="loading">공지사항을 불러오는 중...</div></div></div></section>
    </div>`;
  }
  if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',buildPortalHome,{once:true});else buildPortalHome();
})();
